...
!function (e, t) { "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? exports.AddressFinder = t() : e.AddressFinder = t(); }(window, function () {
    return function (e) { var t = {}; function r(n) { if (t[n])
        ...
        for (var i in e)
        ...
        } }, r.prototype.selectHighlighted = function () { this.element.value = this.highlighted.value, this._hideResults(), this.trigger("result:select", this.highlighted.value, this.highlighted.data), this._dispatchDOMChangeEvent(); }, r.prototype._dispatchDOMChangeEvent = function () { var e; if ("function" == typeof Event)
            ...
            var S = function (e) { var t, r; function n() { for (var t, r = arguments.length, n = new Array(r), i = 0; i < r; i++)
            ...
            var I = function (e) { var t, r; function n(t, r) { var n; return void 0 === r && (r = {}), x(O(n = e.call(this) || this), "ready", function () { return n._ready; }), x(O(n), "_lockSearchRequests", function () { n._ready = !1, n._resume_requests_timer = setTimeout(function () { return n._ready = !0; }, m.MAX_QUERY_TIME); }), x(O(n), "_unlockSearchRequests", function () { n._resume_requests_timer && clearTimeout(n._resume_requests_timer), n._ready = !0; }), x(O(n), "search", function (e) { if (e.length >= m.MIN_SEARCH_CHARS) {
                ...
                var t = E({ q: encodeURIComponent(e), key: n.widget.api_key, format: "json", max: n.widget.options.max_results, wv: m.WIDGET_VERSION, session: n.widget.sessionID });
            ...
            var C = q;
            var D = function (e) { var t, r; function n() { for (var t, r, n, i, s = arguments.length, o = new Array(s), a = 0; a < s; a++)
            ...
            var L = function (e) { var t, r; function n(t, r) { var n; return void 0 === r && (r = {}), N(H(n = e.call(this, t, r) || this), "highlightRenderer", function (e, t) { return void 0 === t.highlighted_a ? new T(e, n.last_query).format() : t.highlighted_a; }), N(H(n), "extraParams", function () { if (n.widget.getOption("location_params"))
                return E(n.widget.getOption("location_params")); }), N(H(n), "createResult", function (e, t) { return new D(e, t); }), n.on("result:select:pre", function (e, t) { return n.widget.trigger("location:select:pre", e, t); }), n.on("result:select", function (e, t) { return n.widget.trigger("location:select", e, t); }), "1" !== n.widget.getOption("location_params").highlight && 1 !== n.widget.getOption("location_params").highlight || (n.options.renderer = n.highlightRenderer), n.autocompleteURL = n.widget.getOption("base_url") + "/api/nz/location", n.infoURL = n.widget.getOption("base_url") + "/api/nz/location/info", n; } return r = e, (t = n).prototype = Object.create(r.prototype), t.prototype.constructor = t, t.__proto__ = r, n; }(I);
            ...
            var V = function (e) { var t, r; function n(t, r) { var n; return void 0 === r && (r = {}), U(z(n = e.call(this, t, r) || this), "highlightRenderer", function (e, t) { return t.highlighted_name_and_address; }), U(z(n), "extraParams", function () { if (n.widget.getOption("points_of_interest_params"))
                return E(n.widget.getOption("points_of_interest_params")); }), U(z(n), "createResult", function (e, t) { return new F(e, t); }), n.on("result:select:pre", function (e, t) { return n.widget.trigger("points_of_interest:select:pre", e, t); }), n.on("result:select", function (e, t) { return n.widget.trigger("points_of_interest:select", e, t); }), "1" !== n.widget.getOption("points_of_interest_params").highlight && 1 !== n.widget.getOption("points_of_interest_params").highlight || (n.options.renderer = n.highlightRenderer), n.autocompleteURL = n.widget.getOption("base_url") + "/api/nz/points_of_interest", n.infoURL = n.widget.getOption("base_url") + "/api/nz/points_of_interest/info", n; } return r = e, (t = n).prototype = Object.create(r.prototype), t.prototype.constructor = t, t.__proto__ = r, n; }(I);
            ...
            var ne = function (e) { var t, r; function n(t, r) { var n; return void 0 === r && (r = {}), re(te(n = e.call(this, t, r) || this), "highlightRenderer", function (e, t) { return t.highlighted_full_address; }), re(te(n), "extraParams", function () { if (n.widget.getOption("address_params"))
                return E(n.widget.getOption("address_params")); }), re(te(n), "createResult", function (e, t) { return new ee(e, t); }), "1" !== n.widget.getOption("address_params").highlight && 1 !== n.widget.getOption("address_params").highlight || (n.options.renderer = n.highlightRenderer), n.on("result:select:pre", function (e, t) { return n.widget.trigger("address:select:pre", e, t); }), n.on("result:select", function (e, t) { return n.widget.trigger("address:select", e, t); }), n.autocompleteURL = n.widget.getOption("base_url") + "/api/au/address/autocomplete", n.infoURL = n.widget.getOption("base_url") + "/api/au/address/info", n; } return r = e, (t = n).prototype = Object.create(r.prototype), t.prototype.constructor = t, t.__proto__ = r, n; }(I);
            ...
            var ce = function (e) { var t, r; function n(t, r) { var n; return void 0 === r && (r = {}), le(ue(n = e.call(this, t, r) || this), "highlightRenderer", function (e, t) { return t.highlighted_full_location; }), le(ue(n), "extraParams", function () { if (n.widget.getOption("location_params"))
                return E(n.widget.getOption("location_params")); }), le(ue(n), "createResult", function (e, t) { return new ae(e, t); }), "1" !== n.widget.getOption("location_params").highlight && 1 !== n.widget.getOption("location_params").highlight || (n.options.renderer = n.highlightRenderer), n.on("result:select:pre", function (e, t) { return n.widget.trigger("location:select:pre", e, t); }), n.on("result:select", function (e, t) { return n.widget.trigger("location:select", e, t); }), n.autocompleteURL = n.widget.getOption("base_url") + "/api/au/location", n.infoURL = n.widget.getOption("base_url") + "/api/au/location/info", n; } return r = e, (t = n).prototype = Object.create(r.prototype), t.prototype.constructor = t, t.__proto__ = r, n; }(I);
            ...
            var de = ce;
            function pe(e, t, r) { return t in e ? Object.defineProperty(e, t, { value: r, enumerable: !0, configurable: !0, writable: !0 }) : e[t] = r, e; }
            var he = function (e) { var t = this; pe(this, "is_valid", function () { return ["au", "nz"].indexOf(t.country_code) >= 0; }), pe(this, "is_nz", function () { return "nz" == t.country_code; }), pe(this, "is_au", function () { return "au" == t.country_code; }), pe(this, "isNearbyServiceAvailable", function () { return t.is_nz(); }), pe(this, "isPointsOfInterestServiceAvailable", function () { return t.is_nz(); }), pe(this, "namespace", function () { return "au" == t.country_code ? "api/au" : "nz" == t.country_code ? "api/nz" : void 0; }), pe(this, "id_attribute", function () { return "au" == t.country_code ? "id" : "nz" == t.country_code ? "pxid" : void 0; }), pe(this, "createAddressService", function (e, r) { return "au" == t.country_code ? new ie(e, r) : "nz" == t.country_code ? new C(e, r) : void 0; }), pe(this, "createLocationService", function (e, r) { return "au" == t.country_code ? new de(e, r) : "nz" == t.country_code ? new M(e, r) : void 0; }), pe(this, "createPointsOfInterestService", function (e, r) { if ("nz" == t.country_code)
                return new W(e, r); }), pe(this, "createNearbyService", function (e, r) { if ("nz" == t.country_code)
                return new J(e, r); }), pe(this, "brochureUrl", function () { return "au" == t.country_code ? m.AU_BROCHURE : "nz" == t.country_code ? m.NZ_BROCHURE : void 0; }), pe(this, "signupUrl", function () { return m.PORTAL_URL + "/signup/" + t.country_code + "/free1"; }), this.country_code = e.toLowerCase(); };
            ...
            var ge = { element: { presence: !0, name: "Input element" }, api_key: { presence: !0 }, country_code: { presence: !0, inclusion: ["AU", "au", "NZ", "nz"] }, "options.container": { presence: !0, name: "Option 'container'" } }, ye = function (e) { var t, r; function n(t, r, n, o) { var h; if (void 0 === o && (o = {}), !function (e, t) { for (var r in t) {
                ...
                return {} || fe(h); var f = !!o.address_params; return _e(fe(h = e.call(this, t, o) || this), "reqwest", function (e) { return e.crossOrigin = !0, e.type = d(), a()(e); }), _e(fe(h), "setOption", function (t, r) { "address_params" == t || "location_params" == t ? h.options[t] = s(h.getOption(t), r) : e.prototype.setOption.call(fe(h), t, r); }), _e(fe(h), "addServices", function () { h.options.show_addresses && h.services.push(h.country.createAddressService(fe(h), {})), h.options.show_locations && h.services.push(h.country.createLocationService(fe(h), {})), h.options.show_points_of_interest && h.country.isPointsOfInterestServiceAvailable() && h.services.push(h.country.createPointsOfInterestService(fe(h), {})), h.options.show_nearby && h.country.isNearbyServiceAvailable() && (navigator.geolocation ? h.services.push(h.country.createNearbyService(fe(h), {})) : h.setInfoPanel("Geolocation not available", { "class": "af_info_panel", cancellable: !0, cancelHandler: h.cancelNearbySearch, persistant: !1 })); }), _e(fe(h), "addService", function (e, t, r) { void 0 === r && (r = {}); var n = new Ae.Service(fe(h), e, t, r); return h.services.push(n), n; }), _e(fe(h), "showResults", function () { return h.options.footer_content = h.options.footer_content || "", e.prototype.showResults.call(fe(h)); }), _e(fe(h), "_renderFooter", function () { if (h.demo) {
                var e = h._renderItem(_.content(h.country));
                return e.style.cssText = _.style, e;
            } if (h.paid && h.options.footer_content)
                return h._renderItem(h.options.footer_content, h.options.footer_class); if (h.paid && h.options.byline) {
                var t = h._renderItem(g.content(h.country), h.options.footer_class);
                return t.style.cssText = g.style, t;
            } if (h.paid)
                return ""; var r = h._renderItem(y.content(h.country), h.options.footer_class); return r.style.cssText = y.style, r; }), h.api_key = r, h.paid = !0, h.options.manual_style || u(h.options.base_url + m.CSS), h._applyStyle("position", h.options.position), i.a.addClass(t, "af-hidden-autofill-icon"), h.country = new he(n), h.options.empty_content = h.options.empty_content || "No addresses were found.\n        This could be a new address, or you may need to check the spelling.\n        <a target='_blank' alt='Missing Addresses Documentation'\n        href=" + h.country.brochureUrl() + "/docs/missing_addresses>Learn more</a>", h.options.address_params.highlight || (h.options.address_params.highlight = 1), h.options.location_params.highlight || (h.options.location_params.highlight = 1), h.options.points_of_interest_params.highlight || (h.options.points_of_interest_params.highlight = 1), h.country.is_nz() && (h.options.address_params.strict || (h.options.address_params.strict = 2)), h.country.is_au() && (f || (h.options.address_params.gnaf = 1)), h.sessionID = p(), h.addServices(), h; } return r = e, (t = n).prototype = Object.create(r.prototype), t.prototype.constructor = t, t.__proto__ = r, n; }(i.a.Widget);
